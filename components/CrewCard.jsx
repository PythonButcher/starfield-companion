...
export default function CrewCard({ name, role, status, photo, email }) {
  ...
  return (
    <div
      className={`flex items-center gap-4 bg-gray-900 border ${borderColor} p-4 rounded-lg shadow-lg hover:bg-gray-800 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_15px_rgba(91,192,222,0.3)]`}
    >
