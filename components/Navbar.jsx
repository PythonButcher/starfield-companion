            ...
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex space-x-6">
                        ...
                        <Link href="/journal" className="text-star-white hover:text-hud-blue transition-colors uppercase text-sm tracking-wider">
                            Journal
                        </Link>
                        <Link href="/planet-pulse" className="text-star-white hover:text-hud-blue transition-colors uppercase text-sm tracking-wider">
                            PlanetPulse
                        </Link>
