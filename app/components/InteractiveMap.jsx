...
export default function InteractiveMap() {
  ...
  const handleMouseMove = (e) => {
    if (isDragging) {
      ...
      const scaleX = viewBox.width / (svg?.clientWidth || 1);
      const scaleY = viewBox.height / (svg?.clientHeight || 1);
  ...
  const handleContextMenu = (e, system) => {
    e.preventDefault();
    setContextMenu({ x: e.clientX, y: e.clientY, system });
  };
  ...
  return (
    <div className="star-map-container" style={{ width: '100%', height: '100%', overflow: 'hidden', position: 'relative' }}>
      <svg
        ref={svgRef}
      ...
      >
        ...
        {systems.map((system) => (
          ...
          >
            ...
            <circle r={selectedSystem?.id === system.id ? 8 : 5} fill="white" filter="url(#glow)" />
      ...
      {contextMenu && (
        ...
        >
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            <li className="menu-item" onClick={() => console.log('Plot Course to', contextMenu.system.name)}>
              Plot Course
            </li>
            <li className="menu-item" onClick={() => console.log('Add Log for', contextMenu.system.name)}>
              Add Log
            </li>
            <li className="menu-item" onClick={() => console.log('View Profile of', contextMenu.system.name)}>
              View Planet Profile
            </li>
          </ul>
        </div>
